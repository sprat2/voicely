		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 1 === $depth && 'enabled' === $this->menu_megamenu_status ) {
				...
				if ( ( ! empty( $this->menu_megamenu_icon ) || ! empty( $this->menu_megamenu_thumbnail ) ) &&
					...
					$item_output = $item_output . '<span class="' . $classes . '">' . $title . '</span>' . $icon;
				} elseif ( $this->menu_style || 0 !== $depth ) {
					$item_output = $item_output . '<span class="' . $classes . '">' . $icon . $title . '</span>';
				} else {
					$item_output = $item_output . $icon . '<span class="' . $classes . '">' . $title . '</span>';
				}
