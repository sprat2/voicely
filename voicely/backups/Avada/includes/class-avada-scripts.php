	...
	public function combine_stylesheets( $original_styles ) {
		...
		if ( 'file' === $this->compiler_mode ) {
			if ( Avada()->settings->get( 'status_fontawesome' ) ) {
				...
				$font_awesome_css = $wp_filesystem->get_contents( FUSION_LIBRARY_PATH . '/assets/fonts/fontawesome/font-awesome.min.css' );
			...
			if ( is_rtl() ) {
				...
				$styles .= $wp_filesystem->get_contents( Avada::$template_dir_path . '/assets/css/rtl.min.css' );
			}
		}
